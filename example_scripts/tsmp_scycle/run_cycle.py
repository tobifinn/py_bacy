...
from py_bacy.pytassim_simplified import PytassimModule
...
def main():
    ...
    cycle.register_model(PytassimModule, 'pytassim', 'terrsysmp',
                         config_path=os.path.join(configs, 'pytassim.yml'))
    cycle.run()
